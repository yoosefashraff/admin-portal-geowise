...
export default function EditProviderPage() {
  ...
  const handleSubmit = (data: z.infer<typeof formSchema>) => {
    console.log('Edit provider form submit', {
      providerId,
      data,
    });
  };
      ...
      <Card className="border-0 shadow-[0px_2px_24px_rgba(16,24,40,0.06) p-6">
        <CardContent className="px-0">
          <div className="flex items-center gap-x-3 mb-4">
            <Link href="/linked-users" className="font-medium text-sm text-gray-500">
              Users
            </Link>
            <ChevronRight className="h-4 w-4 text-gray-300" />
            <span className="font-medium text-sm text-gray-500">User #{providerId}</span>
            <ChevronRight className="h-4 w-4 text-gray-300" />
            <span className="font-medium text-sm text-gray-700">Edit</span>
          </div>
          <h3 className="text-base font-medium sm:text-lg mb-4">Edit User</h3>
                ...
                {steps.map((step) => (
                  <React.Fragment key={step.num}>
                    <div className="flex flex-col items-center min-w-[60px] sm:min-w-0 flex-shrink-0">
                      ...
                      <span
                        className={cn(
                          'text-[10px] sm:text-sm font-medium text-center leading-tight px-1',
                          step.num <= currentStep ? 'text-gray-900' : 'text-gray-300',
                        )}
                      >
                        {step.label}
                      </span>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <div className="px-6 py-3 text-sm font-medium text-gray-500 bg-[#FCFCFD]">Team Name</div>
                  <div className="flex flex-col">
                    <div className="flex items-center gap-[12px] p-6 transition mb-0 border-b-1 border-[#E4E7EC]">
                      ...
                      />
                      <Label htmlFor="checkbox1" className="font-medium">
                        Street Mall - Square Market Team
                      </Label>
                    </div>
                    <div className="flex items-center gap-[12px] p-6 transition mb-0 border-b-1 border-[#E4E7EC]">
                      <Checkbox
                        ...
                        className="size-5 data-[state=checked]:bg-[#F9FAFB] data-[state=checked]:border-[#151C24] data-[state=checked]:text-[#151C24]"
                      />
                      <Label htmlFor="checkbox2" className="font-medium">
                        Rescue Team
                      </Label>
                    </div>
                    <div className="flex items-center gap-[12px] p-6 transition mb-0 border-b-1 border-[#E4E7EC]">
                      <Checkbox
                        ...
                        className="size-5 data-[state=checked]:bg-[#F9FAFB] data-[state=checked]:border-[#151C24] data-[state=checked]:text-[#151C24]"
                      />
                      <Label htmlFor="checkbox3" className="font-medium">
                        Zone Central
                      </Label>
                    </div>
                    <div className="flex items-center gap-[12px] p-6 transition mb-0">
                      <Checkbox
                        ...
                        className="size-5 data-[state=checked]:bg-[#F9FAFB] data-[state=checked]:border-[#151C24] data-[state=checked]:text-[#151C24]"
                      />
                      <Label htmlFor="checkbox4" className="font-medium">
                        Suburban zone
                      </Label>
                    </div>
                  </div>
